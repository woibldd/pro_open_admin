<template>
  <div class="app-container tokenDetails">
    ...
    <div class="header">
      <div class="icon-info">
        <el-avatar class="icon" shape="circle" :size="50" fit="fit" src="https://s2.coinmarketcap.com/static/img/coins/64x64/12909.png" alt="alt"></el-avatar>
        <h1 class="name">Moby Dick</h1>
        <el-tag class="symbol" size="small" type="info" style="margin-right:5px">WOT</el-tag>
        <el-tag size="small" type="info" v-if="true">代币</el-tag>
    ...
    <el-dialog title="拒绝原因" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="danger" @click="submitApproval(0)" :loading="submitLoading">
          审核不通过
        </el-button>
      </div>
    </el-dialog>
...
const calendarTypeOptions = [{ key: 'en', display_name: '英文', tagtype: 'warn' }]
...
const Other1Columus = [
  { label: '浏览器（TXID）:', key: 'browserTx', type: 'string', show: false, value: '' },
